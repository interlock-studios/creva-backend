...
```bash
# Deploy to all regions + setup global HTTPS load balancer with zestai.app
make deploy-full
```
...
3. **Configure zestai.app domain** with proper routing
...
# 2. Setup global load balancer with zestai.app
