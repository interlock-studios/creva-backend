...
def test_process_endpoint_valid_url(
    ...
    with patch('src.api.process.cache_service', mock_cache_service), \
        ...
        # Setup mocks
        mock_cache_service.get_cached_video.return_value = None  # No cache hit
...
def test_process_endpoint_cached_result(
    ...
    with patch('src.api.process.cache_service', mock_cache_service):
        mock_cache_service.get_cached_video.return_value = sample_workout_json
        ...
        mock_cache_service.get_cached_video.assert_called_once_with(valid_tiktok_url, None)
...
def test_process_endpoint_with_localization(
    ...
    with patch('src.api.process.cache_service', mock_cache_service), \
        ...
        mock_cache_service.get_cached_video = AsyncMock(return_value=None)
        ...
        mock_cache_service.cache_video = AsyncMock(return_value=None)
        ...
        mock_cache_service.get_cached_video.assert_called_once_with(valid_tiktok_url, "es")
...
def test_process_endpoint_queue_fallback(
    ...
    with patch('src.api.process.cache_service', mock_cache_service), \
        ...
        mock_cache_service.get_cached_video.return_value = None
